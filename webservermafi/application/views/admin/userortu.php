                      ...
                      <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                 <a class="btn btn-sm btn-info text-white" data-toggle="modal" data-target="#modal_detail<?php echo $row['nisn'];?>">Details</a>
                                  <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal_update<?php echo $row['nisn'];?>">Update</button>
                                  <a data-toggle="modal" data-target="#modal_konfirmasidelete<?php echo $row['nisn'];?>" class="btn btn-sm btn-danger text-white">Delete</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                ...
                <!-- /Conten Header-->
                  ...
                  <div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    <div role="document" class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 id="exampleModalLabel" class="modal-title">Tambah data orang tua</h5>
                          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                        </div>
                         <form method="POST" action="<?php echo base_url('Datauser/createuserortu') ?>">
                          <div class="modal-body">
                  ...
                  <!-- ============ /MODAL TAMBAH ORANG TUA =============== -->
                    ...
                    <!-- ============ MODAL KONFIRMASI DELETE ORANG TUA =============== -->
                  <?php 
                  foreach($data as $row) {
                  ?>
                  <div class="modal fade" id="modal_konfirmasidelete<?php echo $row['nisn'];?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog">
                      <div class="modal-content">
                      <div class="modal-header">
                          <h3 class="modal-title" id="myModalLabel">Delete user orang tua</h3>
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                      </div>
                      <form class="form-horizontal" method="post" action="<?php echo base_url('Datauser/deleteuserortu/');?><?php echo $row['nisn'] ?>">
                          <div class="modal-body">
                  ...
                  <?php }?>
                <!--END MODAL KONFIRMASI DELETE ORANG TUA-->

                 <!-- ============ MODAL DETAIL SISWA =============== -->
                  <?php 
                    foreach($data as $row) {
                  ?>
                  <div id="modal_detail<?php echo $row['nisn'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    <div role="document" class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <div class="modal-body">
                            <div class="form-group">       
                                ...
                                <div class="form-group">
                                  <label>NISN</label>
                                  <input class="form-control" type="text" value="<?php echo $row['nisn'] ?>" name="nis" placeholder="NISN" class="form-control" required="" disabled="">
                                </div>
                                 <div class="form-group">
                                  <label>Password</label>
                  ...
                  <!-- ============ / MODAL DETAIL ORANG TUA =============== -->
                    ...
                    <!-- ============ MODAL UPDATE ORANG TUA=============== -->
                  <?php 
                    foreach($data as $row) {
                  ?>
                  <div id="modal_update<?php echo $row['nisn'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    <div role="document" class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 id="exampleModalLabel" class="modal-title">Tambah data siswa</h5>
                        ...
                        <form method="POST" action="<?php echo base_url('Datauser/updateuserortu/'); ?><?php echo $row['nisn'] ?>">
                          <div class="modal-body">
                            <p>Tambah User Orang tua</p>
                            <input type="hidden" name="level" value="ortu">
                            <div class="form-group">
                              <label>NISN</label>
                              <input type="text" name="nisn" placeholder="NISN" class="form-control" required="" value="<?php echo $row['nisn'] ?>">
                            </div>
                            <div class="form-group">       
                            <label>NIS</label>
                              <input type="text" name="nis" placeholder="NIS" class="form-control" required="" value="<?php echo $row['nis'] ?>">
                            </div>
                            <div class="form-group">       
                              <label>Password</label>
                              <input type="text" name="password" placeholder="password" class="form-control" required="" value="<?php echo $row['password'] ?>">
                            </div>
                          </div>
                          <div class="modal-footer">
                            <button type="submit" data-dismiss="modal" class="btn btn-secondary">Close</button>
