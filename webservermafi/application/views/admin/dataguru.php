                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-12 form-group container-fluid" style="padding-bottom: 20px">
                        ...
                        <form method="post" action="<?php echo base_url("Dataguru/import"); ?>" enctype="multipart/form-data">
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <a href="<?php echo base_url('Dataguru/exportdataguru') ?>" class="btn btn-success text-white">Get .xlsx</a>
