                    ...
                    <div class="col-md-8">
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <?php } elseif ($datadetailizin['status'] == "Decline") { ?>
                          ...
                          <table id="izin" cellpadding="10px" cellpadding="10px" style="font-size: 15px">
                            ...
                            <tr>
                              <td>Bukti</td>
                              <td>:</td>
                              <td><img class="card-img" src="<?php echo base_url('/images/'); ?><?php echo $datadetailizin['bukti'] ?>" style="height: 230px; width: 200px" alt="Card image"></td>
                            </tr>
                            <tr>
                              <td>Alasan</td>
                              <td>:</td>
